...
@WebServlet(
        name = "removeBookOnCart",
        urlPatterns = "/removeBookOnCart"
)
public class RemoveBookOnCart extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (dataBaseAccess.deleteBookOnCart(userId, shopId, isbn) > 0) {
